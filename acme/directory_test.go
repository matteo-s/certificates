...
func TestDirectoryGetLink(t *testing.T) {
	...
	assert.Equals(t, dir.getLink(RevokeCertLink, true, id), "https://ca.smallstep.com/acme/revoke-cert")
	assert.Equals(t, dir.getLink(RevokeCertLink, false), "/revoke-cert")
